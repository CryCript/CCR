/**
 *Cry Cript for verification at BscScan.com on 2022-01-03
*/
...
contract ERC20ReflectDeflation is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private _equityAdress = 0x7504a488A8ef26328F24EBBFc00C11aF586B9eC1;
...
// File contracts/CCRToken.sol

pragma solidity ^0.8.4;

contract CCRToken is ERC20ReflectDeflation {
    address private _equityAdress = 0x7504a488A8ef26328F24EBBFc00C11aF586B9eC1;

    constructor()
        ERC20ReflectDeflation("Cry Cript", "CCR", _equityAdress)
    {}
}
